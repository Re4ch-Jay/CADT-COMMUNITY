...
const Footer = () => {
  return (
    <footer className="p-4 shadow md:px-6 md:py-8 bg-blue-800">
        ...
        <span className="block text-sm sm:text-center text-white">© 3 <a href="https://flowbite.com/" className="hover:underline">Flowbite™</a>. All Rights Reserved.
        </span>
    </footer>
